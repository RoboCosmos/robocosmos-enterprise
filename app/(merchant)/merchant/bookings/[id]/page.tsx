...
import { Calendar, Package, User, Building2, MessageSquare, Send, Check, X } from "lucide-react"
    ...
    <div className="space-y-8">
      ...
      <Card className="bg-gray-900 border-gray-800">
        ...
        <CardContent className="flex flex-wrap gap-3">
          ...
          {booking.status === "confirmed" && <Button variant="outline">Als abgeschlossen markieren</Button>}
